...
_MODULE_FUNCTION_ALLOWLIST: Mapping[str, str] = {
    ...
    "quant_research.bootstrap.worker.build_strategy_study_worker": "stable_public_api",
    "quant_research.bootstrap.worker.build_default_strategy_study_worker": "stable_public_api",
    ...
    "quant_research.infrastructure.persistence.migrations.versions.0009_strategy_studies.upgrade": "framework_entry",
    "quant_research.infrastructure.persistence.migrations.versions.0009_strategy_studies.downgrade": "framework_entry",
