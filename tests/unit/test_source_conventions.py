...
_MODULE_FUNCTION_ALLOWLIST: Mapping[str, str] = {
    ...
    "quant_research.backtest.artifacts.validate_experiment_artifacts": "stable_public_api",
    "quant_research.backtest.artifacts.validate_backtest_artifacts": "stable_public_api",
    "quant_research.backtest.artifacts.publish_experiment_artifacts": "stable_public_api",
    ...
    "quant_research.data.financials.financial_report_period_end": "stable_public_api",
    "quant_research.data.financials.financial_disclosure_deadline": "stable_public_api",
    "quant_research.data.financials.financial_request_is_eligible": "stable_public_api",
    "quant_research.data.pipelines.ingest.partition_to_json": "stable_public_api",
    "quant_research.data.pipelines.ingest.partition_from_json": "stable_public_api",
    ...
    "quant_research.data.safe_files.open_verified_file": "stable_public_api",
    ...
    "quant_research.data.storage.resolved_storage_root": "stable_public_api",
    "quant_research.data.storage.validate_storage_path": "stable_public_api",
    "quant_research.experiments.config.resolve_experiment_yaml": "stable_public_api",
    "quant_research.experiments.config.resolve_experiment_yaml_text": "stable_public_api",
    "quant_research.experiments.config.require_provider_capabilities": "stable_public_api",
    ...
    "quant_research.experiments.registry.validate_transition": "stable_public_api",
    "quant_research.experiments.registry.transition_timestamps": "stable_public_api",
    "quant_research.bootstrap.worker.strategy_factories": "stable_public_api",
    ...
    "quant_research.experiments.verification.validate_registered_publication": "stable_public_api",
    ...
    "quant_research.application.factor_studies.publish_factor_run": "stable_public_api",
    ...
    "quant_research.strategies.base.is_rebalance_boundary": "stable_public_api",
    "quant_research.strategies.base.rebalance_signal_dates": "stable_public_api",
    "quant_research.strategies.base.validated_factor_values": "stable_public_api",
    "quant_research.strategies.base.validated_stock_universe": "stable_public_api",
}
