...
_EXPORTS = {
    ...
    "DecisionData": "base",
    "DualMAConfig": "dual_ma_trend",
    "DualMATrendStrategy": "dual_ma_trend",
    "EtfRotationConfig": "etf_rotation",
    "EtfRotationStrategy": "etf_rotation",
    "MultifactorConfig": "stock_multifactor",
    "MultifactorStrategy": "stock_multifactor",
    "OrderIntent": "base",
    "OrderSide": "base",
    "Strategy": "base",
    ...
    "StrategyProfile": "registry",
    "StrategySpec": "base",
    "TargetWeights": "base",
    "TrendState": "dual_ma_trend",
