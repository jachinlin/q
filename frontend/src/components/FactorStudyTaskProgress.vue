...
const compactMeta = computed(() => [
  view.value.itemPosition ? `当前批次 ${view.value.itemPosition}` : null,
  view.value.signalDate,
...
<template>
  ...
  >
    ...
    <div
      ...
      class="factor-task-progress__item"
      :title="compactMeta"
    >
      {{ compactMeta }}
    </div>
    <div v-else-if="view.itemPosition || view.signalDate" class="factor-task-progress__item">
    ...
    <div
      ...
      class="factor-task-progress__evidence"
    >
...
<style scoped>
.factor-task-progress{min-width:0}.factor-task-progress__heading{display:flex;align-items:center;justify-content:space-between;gap:10px}.factor-task-progress__heading>div{display:flex;min-width:0;align-items:center;gap:8px}.factor-task-progress__heading strong{color:var(--muted);font-size:11px}.factor-task-progress__eyebrow{color:var(--dim);font-size:9px;letter-spacing:.08em;text-transform:uppercase}.factor-task-progress__substage{overflow:hidden;color:var(--blue);font-size:10px;text-overflow:ellipsis;white-space:nowrap}.factor-task-progress__count{flex:none;color:var(--dim);font:10px ui-monospace,Consolas,monospace}.factor-task-progress__message{margin:6px 0;color:var(--muted);font-size:11px;line-height:1.45}.factor-task-progress__item,.factor-task-progress__evidence{display:flex;flex-wrap:wrap;gap:8px;color:var(--dim);font-size:10px}.factor-task-progress__item{margin:0 0 7px}.factor-task-progress__item span+span::before,.factor-task-progress__evidence span+span::before{content:"·";margin-right:8px}.factor-task-progress__evidence{margin-top:8px}.factor-task-progress__subprogress{display:grid;grid-template-columns:max-content 1fr;align-items:center;gap:10px;margin-top:8px;color:var(--dim);font-size:9px}.factor-task-progress--compact{display:grid;grid-template-columns:minmax(110px,160px) minmax(120px,1fr) max-content;grid-template-areas:"stage message count" "item progress progress";align-items:center;column-gap:12px;row-gap:8px;max-width:900px}.factor-task-progress--compact .factor-task-progress__heading{display:contents}.factor-task-progress--compact .factor-task-progress__heading>div{grid-area:stage;overflow:hidden}.factor-task-progress--compact .factor-task-progress__heading strong{flex:none;color:var(--text)}.factor-task-progress--compact .factor-task-progress__count{grid-area:count;justify-self:end}.factor-task-progress--compact .factor-task-progress__message{grid-area:message;overflow:hidden;margin:0;text-overflow:ellipsis;white-space:nowrap}.factor-task-progress--compact .factor-task-progress__item{display:block;grid-area:item;overflow:hidden;margin:0;text-overflow:ellipsis;white-space:nowrap}.factor-task-progress--compact :deep(.el-progress){grid-area:progress}.factor-task-progress--detail{margin:14px 0;padding:16px;border:1px solid var(--border);border-radius:10px;background:var(--surface-raised)}.factor-task-progress--detail .factor-task-progress__heading>div{align-items:baseline}.factor-task-progress--detail .factor-task-progress__heading strong{font-size:13px}.factor-task-progress--detail .factor-task-progress__message{margin:9px 0 7px;font-size:12px}
</style>
