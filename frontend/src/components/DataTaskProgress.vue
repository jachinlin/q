...
<style scoped>
.data-task-progress{min-width:0}.data-task-progress__heading{display:flex;align-items:center;justify-content:space-between;gap:10px}.data-task-progress__heading>div{display:flex;min-width:0;align-items:center;gap:8px}.data-task-progress__heading strong{color:var(--muted);font-size:11px}.data-task-progress__eyebrow{color:var(--dim);font-size:9px;letter-spacing:.08em;text-transform:uppercase}.data-task-progress__count{flex:none;color:var(--dim);font:10px ui-monospace,Consolas,monospace}.data-task-progress__message{margin:6px 0;color:var(--muted);font-size:11px;line-height:1.45}.data-task-progress__dataset{display:flex;gap:8px;margin:0 0 7px;color:var(--dim);font-size:10px}.data-task-progress__dataset span+span::before{content:"·";margin-right:8px}.data-task-progress--compact .data-task-progress__message{overflow:hidden;margin:4px 0;text-overflow:ellipsis;white-space:nowrap}.data-task-progress--compact .data-task-progress__dataset{overflow:hidden;margin-bottom:5px;white-space:nowrap}.data-task-progress--detail{margin:14px 0;padding:16px;border:1px solid var(--border);border-radius:10px;background:var(--surface-raised)}.data-task-progress--detail .data-task-progress__heading>div{align-items:baseline}.data-task-progress--detail .data-task-progress__heading strong{font-size:13px}.data-task-progress--detail .data-task-progress__message{margin:9px 0 7px;font-size:12px}.data-task-progress--detail .data-task-progress__dataset{margin-bottom:10px}
</style>
