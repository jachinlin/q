...
export const routes = [
  ...
  { path: '/strategies', name: 'strategies', component: () => import('./views/StrategiesView.vue'), meta: { title: '策略库' } },
  { path: '/strategies/:strategyId', name: 'strategy-detail', component: () => import('./views/StrategyDetailView.vue'), meta: { title: '策略说明' } },
