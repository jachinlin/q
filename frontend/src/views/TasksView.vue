...
function windowState(window: DataUpdateWindow) {
  if (['stock_financial_indicator', 'stock_income_statement', 'stock_balance_sheet', 'stock_cash_flow_statement', 'stock_master', 'fund_master', 'index_master', 'industry_catalog'].includes(window.dataset)) return '不适用'
