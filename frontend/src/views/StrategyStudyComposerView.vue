      ...
      <div v-if="mode === 'form'" class="study-form" data-mode="form">
        <section class="form-section">
          ...
          <div class="field-grid">
            ...
            <label><span>策略</span><el-select v-model="strategyId" data-field="strategy-id"><el-option v-for="item in catalog.data.value?.strategies ?? []" :key="item" :label="item" :value="item" :disabled="!supportedStrategies.has(item as StrategyForm['strategy_id'])" /></el-select></label>
